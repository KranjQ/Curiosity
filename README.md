...
# Содержание:
- ## [Имеющиеся ручки](#имеющиеся_ручки)
- ## [База данных и Схемы](#база_данных_и_схемы)
- ## [Про реализацию In-memory](#реализация_in-memory)
- ## [Про тесты и coverage](#тесты_и_покрытие)
- ## [Запуск сервиса. Выбор режима данных](#запуск_сервиса)
