...
// Source: curiosity/internal/pkg/content/usecase (interfaces: UserRepository)
...
func (m *MockUserRepository) CreateUser(arg0 context.Context, arg1 models.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) GetUser(arg0 context.Context, arg1 models.User) (models.User, error) {
	m.ctrl.T.Helper()
