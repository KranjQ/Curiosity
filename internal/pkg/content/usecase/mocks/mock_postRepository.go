...
// Source: curiosity/internal/pkg/content/usecase (interfaces: PostRepository)
...
func (m *MockPostRepository) CreatePost(arg0 context.Context, arg1 models.Post) error {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetPostByID(arg0 context.Context, arg1 int) (models.Post, error) {
	m.ctrl.T.Helper()
...
func (m *MockPostRepository) GetPosts(arg0 context.Context) ([]models.Post, error) {
	m.ctrl.T.Helper()
